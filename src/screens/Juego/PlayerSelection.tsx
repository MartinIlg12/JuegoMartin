...
interface Player {
    ...
    const players: Player[] = [
        ...
        { id: 2, name: 'Emiliano Martínez', position: 'PO', jerseyNumber: 22, imageUri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqA_MQur-dyjNlfrk37oablRcMAULOR9DAOI6zecB8VzmjU0BREsVp0nouZUBmkm8kA0Q&usqp=CAU', nationality: 'Argentina', team: 'Aston Villa', rating: 4.0 },
        ...
        { id: 6, name: 'Ronald Araújo', position: 'DFC D', jerseyNumber: 5, imageUri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcS3yFe6QX2h26k5PyF3m4_fjt97DFFTdRGt9Z1vyCqk2t5UMKClsxbWZpwCA8XtenHnI&usqp=CAU', nationality: 'Uruguay', team: 'Barcelona', rating: 4.0 },
        ...
        { id: 8, name: 'John Stones', position: 'DFC I', jerseyNumber: 6, imageUri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7iKCnAaYb8n0iBjqX_X1lKxVzLiV7nJRerH-oLEu-zcR5G1KXnnJga2IrFnjhCxiQFxk&usqp=CAU', nationality: 'Inglaterra', team: 'Manchester City', rating: 4.3 },
        { id: 9, name: 'Alexander-Arnold', position: 'LD', jerseyNumber: 66, imageUri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL3tJLLze4Jt4d-3KeBiGBx-9AZhllbUngMq98e3J9RO5zkaGTfWmZ50jIBbqWnSckrq8&usqp=CAU', nationality: 'Inglaterra', team: 'Liverpool', rating: 4.8 },
        ...
        { id: 22, name: 'Lionel Messi', position: 'DC', jerseyNumber: 10, imageUri: 'https://s0.rbk.ru/v6_top_pics/media/img/0/99/756708616772990.jpg', nationality: 'Argentina', team: 'Inter Miami', rating: 4.5},
        ...
        { id: 25, name: 'Kylian Mbappé', position: 'DC', jerseyNumber: 33, imageUri: 'https://tmssl.akamaized.net/images/foto/galerie/mbappe-kylian-2022-2023-psg-1032346914hjpg-1690297101-112393.jpg?lm=1690297120', nationality: 'Francia', team: 'Real Madrid', rating: 4.9 },
    ];
