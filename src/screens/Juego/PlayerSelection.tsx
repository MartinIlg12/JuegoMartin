...
interface Player {
    ...
    { id: 5, name: 'Virgil Van Dijk', position: 'DFC', jerseyNumber: 4, imageUri: 'https://i2-prod.liverpool.com/article29105074.ece/ALTERNATES/s615/0_GettyImages-2149558157.jpg' },
    { id: 6, name: 'Piero Hincapie', position: 'DFC', jerseyNumber: 3, imageUri: 'https://tmssl.akamaized.net/images/foto/galerie/piero-hincapie-1697649381-119813.jpg?lm=1697649404' },
    { id: 7, name: 'Ronald Araujo', position: 'DFC', jerseyNumber: 5, imageUri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcS3yFe6QX2h26k5PyF3m4_fjt97DFFTdRGt9Z1vyCqk2t5UMKClsxbWZpwCA8XtenHnI&usqp=CAU' },
    { id: 8, name: 'Jon Stones', position: 'DFC', jerseyNumber: 6, imageUri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7iKCnAaYb8n0iBjqX_X1lKxVzLiV7nJRerH-oLEu-zcR5G1KXnnJga2IrFnjhCxiQFxk&usqp=CAU' },
    ...
    { id: 13, name: 'Enzo Fernandez', position: 'MCO', jerseyNumber: 17, imageUri: 'https://tmssl.akamaized.net/images/foto/galerie/fernandez-enzo-2022-23-argentina-1669743888-97704.jpg?lm=1669743899' },
    { id: 14, name: 'Jude Bellingham', position: 'MCO', jerseyNumber: 22, imageUri: 'https://i2-prod.football.london/incoming/article27646001.ece/ALTERNATES/s1200c/1_GettyImages-1656777561.jpg' },
    { id: 16, name: 'Cole Palmer', position: 'MCO', jerseyNumber: 20, imageUri: 'https://i2-prod.football.london/incoming/article27700557.ece/ALTERNATES/s615/0_GettyImages-1655017744.jpg' },
    { id: 17, name: 'Pedri', position: 'MCO', jerseyNumber: 8, imageUri: 'https://tmssl.akamaized.net/images/foto/galerie/pedri-fc-barcelona-2022-2023-1682349156-106037.jpg?lm=1682349250' },
    ...
    return (
        <View style={styles.container}>
            <IconButton
                ...
                />
            <Text style={styles.title}>Elige el Capitán</Text>
            {selectedPlayer && (
